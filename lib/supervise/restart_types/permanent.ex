defmodule Supervise.RestartTypes.Permanent do
  use Supervisor
  ...
  @child_names [
    :restart_permanent_worker1,
    :restart_permanent_worker2,
    :restart_permanent_worker3
  ]
  ...
  def init(:ok) do
    ...
    children = Enum.map(@child_names, &SimpleWorker.build_spec(&1, :permanent))
